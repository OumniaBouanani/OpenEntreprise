...
const Contribute = () => {
    return (
        <div className=' text-center'>
            <h1 className="text-3xl md:text-6xl font-bold mb-6 mx-auto">Help us improve Open Enterprise</h1>
            <p className="mr-4 ml-4 text-sm md:text-lg">As an Open Enterprise ourselves, we are actively looking for new talent to join our mission of improving and delivering the Open Enterprise model to the world. Apply for open tasks and earn a stake in our success.</p>
            <div className='flex flex-col sm:flex-row sm:grid-cols-3 mx-auto md:ml-16 mt-12 '>
                ...
                <div className='w-[427px] h-[216px] bg-white rounded-[16px] shadow-xl ml-8 mt-8 md:mt-auto'>
            ...
            <button className="rounded-[16px] font-thin text-lg mt-16 mb-24 bg-[#303031] text-white w-[136px] h-[64px]">View more</button>
        </div>
    )
