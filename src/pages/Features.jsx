...
const Features = () => {
    return (
        <div className="py-16 item-center text-center">
            <h1 className="text-6xl font-bold mb-6">Reimagining what it means to work</h1>
            <p className="text-lg">Teams and communities using Open Enterprise fundamentally unlock a reality of work that reimagines how people<br/> engage in economic opportunity, meeting the demands and expectations of a modern organization.</p>
            <div className="flex flex grid-cols-3 mt-12 ml-24 mr-24">
                    <div className="w-1/3 h-72  bg-white pt-8 mr-8 rounded-lg shadow-xl">
                    ...
                    <div className="w-1/3 h-72 content-center bg-white pt-8 mr-8 rounded-lg shadow-xl">
            ...
            <div className="flex flex grid-cols-2 my-24 ml-8 ">
                <div className="mt-16 mr-24">
                    <img src={Icon1} alt="" className="mx-left" />
                    <h1 className="text-[40px] font-extrabold mt-8 text-left ">Kickstart an organization with <br/> your co-founders</h1>
                    <p className="text-left text-sm mt-6">It’s the early days, you just had a long conversation with two friends about a <br/> meaningful challenge that you’re all passionate about and have a potential solution <br/> for. You’re ready to embark the startup journey.</p>
                </div>
                <div className="w-[400px] h-[360px] bg-white mt-4 ml-32 border border-black border-solid border-4 rounded-lg shadow-md shadow-[#71A894] ">
            ...
            <div className="flex flex grid-cols-2 my-24 ml-8  ">
                <div className="w-[400px] h-[360px] bg-white mt-4 ml-16 mr-16 border border-black border-solid border-4 rounded-lg shadow-md shadow-[#71A894] ">
                ...
                <div className="mt-12 ml-32">
                    <img src={Icon1} alt="" className="mx-left" />
                    <h1 className="text-[40px] font-extrabold mt-8 text-left ">Onboard users, investors <br /> and advisors as you grow</h1>
                    <p className="text-left text-sm mt-6">It’s the early days, you just had a long conversation with two friends about a <br/> meaningful challenge that you’re all passionate about and have a potential solution <br/> for. You’re ready to embark the startup journey.</p>
                </div>
            </div>
            <div className="flex flex grid-cols-2 my-24 ml-8 ">
                <div className="mt-16 mr-24">
                    <img src={Icon1} alt="" className="mx-left" />
                    <h1 className="text-[40px] font-extrabold mt-8 text-left ">Engage highly committed <br />contributors</h1>
                    <p className="text-left text-sm mt-6">You need talented people on-demand across various tasks that your full-time <br /> workforce can’t prioritize at the moment. As an Open Enterprise, you can easily fund <br /> tasks and have people apply to work on them in return for funds or shares.</p>
                </div>
                <div className="mt-4 ml-24 ">
                    <div className="w-[560px] ml-8 h-[160px] bg-white border border-black border-solid border-4 rounded-[16px]">
                        <div className=" mt-4  ml-6 flex flex grid-cols-2">
                            ...
                            <div className="w-[82px] h-[32px] bg-[#71A894] text-white ml-24 rounded-[40px] pt-[4px] pb-[4px] pl-[8px] pr-[8px]" >1 SHARE</div>
                        </div>
                        <p className="font-light ml-6 mt-2 text-[16px] text-left ">Looking for an amazing copywriter using <br /> Open Enterprise to help us write an article <br /> on how to get started.</p>
                    </div>
                    <div className="flex flex grid-cpls-2 mt-6">
                        <div className="mr-4  w-[381px] h-[288px] bg-[#F3F0EA] border border-black border-solid border-4 rounded-[16px]">
                        ...
                        <div className="w-[240px] h-[288px] mt-2 bg-white border border-[#71A894] border-solid border-4 rounded-[16px]">
